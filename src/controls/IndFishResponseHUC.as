...
package controls
{
	import controls.skins.IndFishResponseHUC;
	...
	public class IndFishResponseHUC extends spark.components.SkinnableContainer
	{
		...
		override public function stylesInitialized():void {  
			...
			this.setStyle("skinClass",Class(controls.skins.IndFishResponseHUC));
		}
